...
<body ng-controller="selectionCtrl" ng-init="ShowMap(3)"> <!--ng-init="ShowMap()"-->
<!--////////////////////////////////Главное меню///////////////////////////////////////-->
	<?php 
				...
				<h4>
					<?php 
						try{
							...
							$sql = ' SELECT text FROM posts WHERE page = "../functionality/selection/sushi.php"';
			...
			<div class="col-md-12 table-responsive">
				<table class="table table-condensed table-striped" ts-wrapper>
					...
					<tbody class="table-bordered">
						<tr ng-repeat="data in dbSushiInfo" ts-repeat ts-hide-no-data ng-style="{display: tableRowCSSStatus[$index]}">
							<td>{{data.name}}</td>
